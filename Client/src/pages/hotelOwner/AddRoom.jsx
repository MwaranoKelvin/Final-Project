...
const AddRoom = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      //Converting Amenitis to Array & keeping only enabled Amenities
  ...
  return (
    <form onSubmit={onSubmitHandler} >
      <Title align='left' font='outfit' title='Add Room' subTitle='Fill in the details carefully and accurate room details, pricing, and amenities, ot enhance the user booking experience.' />
